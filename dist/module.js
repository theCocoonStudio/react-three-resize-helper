import {useState as $aODKb$useState, useEffect as $aODKb$useEffect} from "react";
...
$parcel$export($393673603234b845$exports, "useResizeHelper", function () { return $393673603234b845$export$bd0a946f6f3d2bb1; }, function (v) { return $393673603234b845$export$bd0a946f6f3d2bb1 = v; });
...
const $9c25e1fa1df40573$var$handleResize = (ref, options, camera)=>{
    ...
    const _height = 2 * Math.tan(_vFOV / 2) * Math.abs(_ref.current.position.z - _camera.position.z); // visible height
    ...
    const { _aspect: _aspect  } = _camera;
    if (_options) {
        let { breakpoints: breakpoints , positions: positions , rotations: rotations , scales: scales , fovs: fovs , camZs: camZs , useMin: useMin  } = _options;
        //basic validation
        ...
        /* find the array index for the changes to implement */ let actionIndex;
...
$393673603234b845$export$bd0a946f6f3d2bb1 = $9c25e1fa1df40573$export$bd0a946f6f3d2bb1;


export {$393673603234b845$export$bd0a946f6f3d2bb1 as useResizeHelper, $393673603234b845$exports as default};
